...
export const metadata = {
  ...
  keywords: "web design portfolio, web development projects, case studies, client work",
}
  ...
  const projects = [
    {
      ...
      description: "A complete rebrand and website redesign for an eco-friendly products company.",
    ...
    },
    {
      ...
      description: "A custom dashboard for a tech startup to manage their customer data and analytics.",
    ...
    },
    {
      ...
      category: "E-commerce",
      description: "An e-commerce platform for a gourmet food delivery service with online ordering.",
    ...
    },
    {
      ...
      description: "A responsive website for a fitness center with class scheduling and member portal.",
    ...
    },
    {
      ...
      description: "A portfolio website for a professional photographer showcasing their work.",
    ...
    },
    {
      ...
      description: "A professional website for a law firm with service information and contact forms.",
        ...
        <div className="container px-4 md:px-6">
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {projects.map((project) => (
              <Link key={project.id} href={`/portfolio/project-${project.id}`} className="group">
